...
public class currency_converter{
    public static void main(String[] args) {
        ...
        System.out.println("    Welcome to Currency Converter!     ".toUpperCase());
        System.out.println("-------------------------------------------------");
        System.out.println("|              1. UAE to Rupee                  | ");
        ...
        if(choice==1){
            System.out.println("enter the amount in dihram");
            ...
            System.out.println("Invalid choice. Please select 1 or 2 or 3 or 4 or 5.");
        }
